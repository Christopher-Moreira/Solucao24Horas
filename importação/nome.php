...
if ($data !== null) {
    ...
    foreach ($data['RETORNO'] as $item) {
        ...
        //    echo "DOCUMENTO: " . $item['DOCUMENTO'] . "<br>";
            ...
            // Verifica se a substring extraída é igual a "456547"
            if ($substring === "322750") {
             // echo "A substring '{$substring}' é igual a '456547'.<br>";
             // echo $documento = $item['DOCUMENTO'];
              // é aqui que chamo o resto da integração.
              
              
              //////////////////////////////////////////////////////////////////////realizar o insert na api///////////////////////////////////
             echo $documento = $item['DOCUMENTO'];
